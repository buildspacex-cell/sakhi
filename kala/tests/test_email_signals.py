...
from kala.signals.email.avoidance import AvoidanceDetector
from kala.signals.email.boundary import BoundaryDetector
from kala.signals.email.cognitive_load import CognitiveLoadAnalyzer
...
from kala.signals.email.subscription import SubscriptionDetector
