...
| Simulation continuity compiler | ✅ | `unit/services/test_simulation_continuity.py`, `unit/services/test_simulation_continuity_benchmark.py` | Topic classification benchmark, deterministic compile output, bounded related-anchor projection for shared moments across threads, and arc construction safeguards |
