...
const productPanels: ProductPanel[] = [
  ...
  },
  {
    ...
    lead: "Patterns stop feeling abstract when they show up as living threads.",
    details: [
      "You begin to see what is actually taking your attention, and what is missing.",
      "And over time, your story starts to take shape.",
    ],
  ...
  },
  {
    ...
    src: "/story/moments.png",
    alt: "Sakhi moments timeline screen",
    caption: "A timeline of real entries, not a generic summary.",
  },
  {
    key: "grounded",
    label: "Grounded Reflection",
    headline: "Every insight stays grounded in your reality.",
    lead: "Every insight is backed by something you actually lived.",
    details: [
      "You can always return to the moment behind the insight, not just the conclusion.",
      "And over time, those connections begin to reveal patterns.",
    ],
    src: "/story/insights.png",
    alt: "Sakhi grounded reflection detail screen",
    caption: "The moment behind every insight is always there.",
  },
  {
    key: "synthesis",
    label: "Synthesis",
    headline: "Your life starts to make sense.",
    ...
    src: "/story/reflection.png",
    alt: "Sakhi synthesis reflection screen",
    caption: "What matters becomes clear.",
  },
  {
    key: "privacy",
    label: "Privacy",
